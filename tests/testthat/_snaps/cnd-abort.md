...
# if `call` is older than handler caller, use that as bottom
    ...
    Output
      ...
      Backtrace:
       ...
       15. | | \-base::withCallingHandlers(...)
       16. | \-base::withVisible(do)
       17. +-base::print(expect_error(f()))
       18. +-testthat::expect_error(f())
       19. | \-testthat:::expect_condition_matching(...)
       20. |   \-testthat:::quasi_capture(...)
       21. |     +-testthat (local) .capture(...)
       22. |     | \-base::withCallingHandlers(...)
       23. |     \-rlang::eval_bare(quo_get_expr(.quo), quo_get_env(.quo))
       24. \-rlang (local) f()
    Code
      low_level <- (function(call) {
...
# base causal errors include full user backtrace
    ...
    Output
      ...
      Backtrace:
       ...
       15. | | \-base::withCallingHandlers(...)
       16. | \-base::withVisible(do)
       17. +-base::print(expect_error(my_verb(add(1, ""))))
       18. +-testthat::expect_error(my_verb(add(1, "")))
       19. | \-testthat:::expect_condition_matching(...)
       20. |   \-testthat:::quasi_capture(...)
       21. |     +-testthat (local) .capture(...)
       22. |     | \-base::withCallingHandlers(...)
       23. |     \-rlang::eval_bare(quo_get_expr(.quo), quo_get_env(.quo))
       24. +-rlang (local) my_verb(add(1, ""))
       25. | \-rlang (local) with_chained_errors(expr)
       26. |   \-rlang::try_fetch(...)
       27. |     +-base::tryCatch(...)
